...
(async()=>{
 ...
 Object.assign(ctx,{activeStarters:c=>squads[c.id],backgroundClubStrength:()=>75,matchMoraleModifier:()=>0,matchFitnessModifier:()=>0,v23TeamSharpness:()=>0,currentClub:home,userTacticalModifier:()=>0});
