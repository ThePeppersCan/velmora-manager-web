(async function(){
  ...
  try{
    ...
    const script=document.createElement('script');const cacheKey=window.VELMORA_RELEASE?.cacheKey||'v103-living-club-pulse-20260908';script.src=`app.js?v=${encodeURIComponent(cacheKey)}`;document.body.appendChild(script);
  }
