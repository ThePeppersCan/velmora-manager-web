(async function(){
  ...
  try{
    ...
    const script=document.createElement('script');const cacheKey=window.VELMORA_RELEASE?.cacheKey||'v104-5-multiplayer-integrity-20260909';script.src=`app.js?v=${encodeURIComponent(cacheKey)}`;document.body.appendChild(script);
  }
