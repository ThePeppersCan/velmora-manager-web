(async function(){
  ...
  try{
    ...
    const script=document.createElement('script');const cacheKey=window.VELMORA_RELEASE?.cacheKey||'v105-2-career-polish-20260911';script.src=`app.js?v=${encodeURIComponent(cacheKey)}`;document.body.appendChild(script);
  }
